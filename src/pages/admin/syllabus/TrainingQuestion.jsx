...
import { apiGet, apiPostUpload, apiPost, apiDelete } from "../../../api/axios";
...
function TrainingQuestion() {
  ...
  const handleDeleteClick = (question) => {
    console.log(question._id, "question id");
  ...
  const deleteQuestion = async () => {
    try {
      // console.log(deleteId, " question Id");
      const response = await apiDelete(`/deleteQuestion/${deleteId}`);

      if (response.data.status === 200) {
        snackbarEmitter("Question deleted successfully", "success");
    ...
    <Navbar title={"Syllabus"}>
      ...
      >
        ...
        >
          <CustomTypography
            text={syllabusName}
            onClick={() => navigate(`${routePrefix}/trainingSyllabus`)}
            sx={{
              fontSize: { xs: "10px", md: "14px", sm: "14px" },
              cursor: "pointer",
          ...
          <CustomTypography
            text=">"
            sx={{ fontSize: { xs: "10px", md: "14px", sm: "14px" } }}
          />
          <CustomTypography
            text={bookName}
                    ...
                    >
                      ...
                      <TableCell>
                        ...
                        <CustomButton
                          ...
                          loading={false}
                          bgColor={
                            question.isactive === true ? "#109CF1" : "#D61508"
                          }
                          sx={{
