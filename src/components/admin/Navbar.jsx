    ...
    try {
      ...
      if (response.data.status === 200) {
        setAdminData({
          ...
          firstname:
            response.data.data.firstname || response.data.data.instituteName,
    ...
    <Grid container sx={{ minHeight: "100vh" }}>
      ...
      <Grid
        ...
        sx={{
          ...
          boxShadow: {
            xs: sidebarOpen ? "2px 0 5px rgba(0,0,0,0.3)" : "none",
            md: "none",
          },
        }}
      >
            ...
            <List>
              ...
              <ListItem
                ...
                sx={{
                  ...
                  borderRadius: 2,
                  mb: 1,
                  bgcolor: isActive(`${routePrefix}/dashboard`)
                    ? "#EAB308"
                    : "white",
              ...
              >
                ...
                <CustomTypography
                  text="Dashboard"
                  color={
                    isActive(`${routePrefix}/dashboard`) ? "white" : "#8F95B2"
                  }
              ...
              <ListItem
                ...
                sx={{
                  ...
                  borderRadius: 2,
                  mb: 1,
                  bgcolor: isActive(`${routePrefix}/trainingsyllabus`)
                    ? "#EAB308"
                    : "white",
                  cursor: "pointer",
                  ":hover": {
              ...
              >
                ...
                <CustomTypography
                  text="Syllabus"
                  color={
                    isActive(`${routePrefix}/trainingsyllabus`)
                      ? "white"
                      : "#8F95B2"
                  }
                  fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
              ...
              >
                ...
                />
                {openDatabase ? (
                  <ExpandLess sx={{ color: "#8F95B2" }} />
                ) : (
                  <ExpandMore sx={{ color: "#8F95B2" }} />
                )}
              </ListItem>
              ...
              <Collapse in={openDatabase} timeout="auto" unmountOnExit>
                ...
                <ListItem
                  ...
                  sx={{
                    ...
                    mb: 1,
                    borderRadius: 2,
                    bgcolor: isActive(`${routePrefix}/trainingAdd`)
                      ? "#EAB308"
                      : "white",
                ...
                >
                  ...
                  <CustomTypography
                    text="Training"
                    color={
                      isActive(`${routePrefix}/trainingAdd`)
                        ? "white"
                        : "#8F95B2"
                    }
                    fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
                ...
                {instituteToken && (
                  <ListItem
                    ...
                    sx={{
                      ...
                      mb: 1,
                      borderRadius: 2,
                      bgcolor: isActive(`${routePrefix}/test`)
                        ? "#EAB308"
                        : "white",
                      // color: isActive('/admin/trainingAdd') ? 'white' : 'black',
                      cursor: "pointer",
                  ...
                  >
                    ...
                    <CustomTypography
                      text="Test"
                      color={
                        isActive(`${routePrefix}/test`) ? "white" : "#8F95B2"
                      }
                      fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
                      mb={0}
                      fontWeight={500}
                ...
                <ListItem
                  ...
                  sx={{
                    pl: 4,
                    borderRadius: 2,
                    bgcolor: isActive(`${routePrefix}/feedback`)
                      ? "#EAB308"
                      : "white",
                ...
                >
                  ...
                  <CustomTypography
                    text="Feedback"
                    color={
                      isActive(`${routePrefix}/feedback`) ? "white" : "#8F95B2"
                    }
                    fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
                    mb={0}
                    fontWeight={500}
              ...
              {adminToken && (
                <ListItem
                  ...
                  sx={{
                    ...
                    borderRadius: 2,
                    mb: 1,
                    bgcolor: isActive(`${routePrefix}/pricing`)
                      ? "#EAB308"
                      : "white",
                ...
                >
                  ...
                  <CustomTypography
                    text="Pricing"
                    color={
                      isActive(`${routePrefix}/pricing`) ? "white" : "#8F95B2"
                    }
                    fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
                    mb={0}
                    fontWeight={500}
              ...
              {adminToken && (
                <ListItem
                  ...
                  sx={{
                    ...
                    borderRadius: 2,
                    mb: 1,
                    bgcolor: isActive(`${routePrefix}/institution`)
                      ? "#EAB308"
                      : "white",
                    // color: isActive('/admin/pricing') ? 'white' : 'black',
                    cursor: "pointer",
                ...
                >
                  ...
                  <CustomTypography
                    text="Institution"
                    color={
                      isActive(`${routePrefix}/institution`)
                        ? "white"
                        : "#8F95B2"
                    }
                    fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
              ...
              <ListItem
                ...
                sx={{
                  ...
                  borderRadius: 2,
                  mb: 1,
                  bgcolor: isActive(`${routePrefix}/studentProfile`)
                    ? "#EAB308"
                    : "white",
                  // color: isActive('/admin/pricing') ? 'white' : 'black',
                  cursor: "pointer",
              ...
              >
                ...
                <CustomTypography
                  ...
                  color={
                    isActive(`${routePrefix}/studentProfile`)
                      ? "white"
                      : "#8F95B2"
                  }
                  fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
              ...
              {adminToken && (
                <ListItem
                  ...
                  sx={{
                    ...
                    borderRadius: 2,
                    mb: 1,
                    bgcolor: isActive(`${routePrefix}/advertise`)
                      ? "#EAB308"
                      : "white",
                    // color: isActive('/admin/pricing') ? 'white' : 'black',
                    cursor: "pointer",
                ...
                >
                  ...
                  <CustomTypography
                    text="Advertise"
                    color={
                      isActive(`${routePrefix}/advertise`) ? "white" : "#8F95B2"
                    }
                    fontSize={{ xs: "14px", sm: "16px", md: "16px" }}
                    mb={0}
                    fontWeight={500}
      ...
      >
        <DialogTitle id="logout-dialog-title">
          <CustomTypography
            text="Confirm Logout?"
            fontSize={{ xs: "16px", md: "18px", sm: "18px" }}
            fontWeight={600}
          />
        </DialogTitle>
        <DialogContent>
        ...
        <DialogActions sx={{ display: "flex", gap: 0.5, mb: 1 }}>
          <CustomButton
            ...
            bgColor="#EAB308"
            sx={{
              width: { xs: "50%", md: "30%", sm: "30%" },
              fontSize: { xs: "11px", md: "13px", sm: "13px" },
            }}
          />
          <CustomButton
            children="Cancel"
      ...
      >
        ...
        <AppBar position="static" color="white" elevation={0}>
          ...
          >
            ...
            >
              <Avatar
                ...
                src={
                  instituteId
                    ? instituteData?.institeDetails?.profileimage
                    : adminData?.profileimage
                }
              >
                {instituteId
                  ? instituteData?.institeDetails?.instituteName
          ...
          >
            ...
            <CustomTypography
              text={title}
              fontSize={{ xs: "18px", md: "22px", sm: "22px" }}
              fontWeight={600}
            />
          ...
          >
            ...
            <CustomTypography
              text={title}
              fontSize={{ xs: "20px", md: "22px", sm: "22px" }}
              fontWeight={600}
            />
